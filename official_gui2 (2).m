...
%   r1          length of arm 1 
%   r2          length of arm 2 
global s hInput1 hInput2 hPlot hFig hTimer c t1 t2 

%% Set up
% Create serial port object
s = serialport("/dev/cu.debug-console", 9600);
...
global s hInput1 hInput2 r1 r2
    ...
    r1 = 111.064;
    r2 = 111.374;
    [thetas] = inverse_kinematics(input1, input2, r1, r2);
    
    % format command values as a string, e.g. C40.0,3.5;
    cmdStr = sprintf("C%.2f,%.2f;", thetas(1), thetas(2));
...
global s hPlot c t1 t2
    ...
    eth1 = data(2);
    eth2 = data(3);
    Tf = forward_kinematics(r1, r2, eth1, eth2);
