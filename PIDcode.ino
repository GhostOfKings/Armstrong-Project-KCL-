...
float demandPositionInDegrees_m1 = 256.1; //Position that we are inputting into motor 1 in degrees
float demandPositionInDegrees_m2 = 256.1; //Position that we are inputting into motor 2 in degrees
